...
//		System.setOut(new PrintStream(new FileOutputStream("/D:/method.txt")));
//		BuilderUtil.androidDx("/D:/a.dex", Arrays.asList("/D:/android/classes/dexClasses1"), true);
...
//		String classFullFilename="/D:/android1/classes/sdk/com/tencent/mm/algorithm/DES.class";
...
//		System.out.println(allocStat.getTotalAlloc()+","+allocStat.getMethodCount());
	...
	public static class AllocStat{
		...
		/**
		 * @param totalAlloc the totalAlloc to set
		 */
		...
		/**
		 * @param methodReferenceList the methodReferenceList to set
		 */
		...
		/**
		 * @param methodReferenceMap the methodReferenceMap to set
		 */
		...
		/**
		 * @param fieldReferenceMap the fieldReferenceMap to set
		 */
